...
- **Image generation** is built in for **OpenAI**, **Gemini**, **OpenRouter**, and the generic **OpenAI-compatible** connector (any endpoint that implements the OpenAI Images API, `POST /v1/images/generations`).
