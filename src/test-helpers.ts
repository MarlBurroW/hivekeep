...
export const fullMockConfig = {
  ...
  tools: { maxSteps: 100, turnTimeoutMs: 1_800_000 },
  llm: { adaptiveThinking: true, streamIdleTimeoutMs: 120_000 },
  search: { requestTimeoutMs: 30_000 },
  email: { requestTimeoutMs: 60_000 },
  hooks: { handlerTimeoutMs: 30_000 },
